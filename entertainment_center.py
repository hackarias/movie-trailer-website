...
# All the movies I want to show together with a movie title and movie trailer
# for the Movie class
...
angelas_ashes = media.Movie(
    "Angela's Ashes",
    "https://www.youtube.com/watch?v=6zLpf1XDNko"
)
the_mist = media.Movie(
    "The Mist",
...
jude = media.Movie(
    "Jude",
    "https://www.youtube.com/watch?v=tIHhTaSsANQ"
)
doctor_zhivago = media.Movie(
    "Doctor Zhivago",
    "https://www.youtube.com/watch?v=hvIL_A0UsJk"
)
grave_of_the_fireflies = media.Movie(
